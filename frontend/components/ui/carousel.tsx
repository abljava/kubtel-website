    ...
    return (
      <div ref={ref} className={`flex justify-center ${props.className}`}>
        {Array.from({ length: numberOfSlides }, (_, i) => (
          <Button
            key={i}
            className={`mx-1 first-of-type:ml-0 last-of-type:mr-0 h-5 w-5 rounded-full p-0 ${
              i === currentSlide
                ? "transform bg-white hover:bg-white"
                : "bg-transparent border-2 border-white hover:bg-white"
            }`}
